...
export function ContactInfo({ showMap = true }: { showMap?: boolean }) {
  return (
    <div className="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
      <div className="d-flex align-items-center p-3">
        ...
        <div className="px-2">
          <h2 className="h6 fw-bold mb-0">Phone</h2>
          <a href={`tel:${site.phoneGlobe}`}>GLOBE: {site.displayPhoneGlobe}</a>
        </div>
      </div>
      <div className="d-flex align-items-center p-3">
        <div className="bs-icon-md bs-icon-circle bs-icon-primary shadow d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md">
        ...
        <div className="px-2">
          <h2 className="h6 fw-bold mb-0">Email</h2>
      ...
      <div className="d-flex align-items-center p-3">
        ...
        <div className="px-2">
          <h2 className="h6 fw-bold mb-0">Location</h2>
